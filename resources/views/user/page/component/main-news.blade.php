        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                    ...
                    <div class="position-relative overflow-hidden" style="height: 435px;">
                        ...
                        <div class="overlay">
                            <div class="mb-1">
                                <a class="text-white" href="page/{{ $news->newsType->category->unsigned_name }}/{{ $news->newsType->id }}/{{ $news->newsType->unsigned_name }}">{{ $news->newsType->name }}</a>
                                <span class="px-2 text-white">/</span>
                                <a class="text-white" href="">{{ $news->created_at->toFormattedDateString(); }}</a>
                            </div>
                            <a class="h2 m-0 text-white font-weight-bold" href="page/{{ $news->id }}/{{ $news->title }}">{{ $news->title }}</a>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="col-lg-4">
                <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                    ...
                    <a class="text-secondary font-weight-medium text-decoration-none" href="home">View All</a>
                </div>
